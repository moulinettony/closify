...
const AnimatedWrapper: React.FC<AnimatedProps> = ({ children, delay = 0, className = '' }) => {
      ...
      <div style={{ maxWidth: '1300px' }} className="mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-16 lg:grid lg:grid-cols-2 lg:gap-16">
          <AnimatedWrapper delay={0}>
            <div className="rounded-2xl flex flex-col justify-between h-full py-16 px-4 lg:p-20" style={cardStyle}>
              <div>
          ...
          <div className="mt-12 lg:mt-0">
            ...
            <AnimatedWrapper delay={300} className="mt-8 text-left">
        ...
        <div className="mt-32 lg:grid lg:grid-cols-3 gap-10 grid grid-cols-1">
          <AnimatedWrapper delay={0}>
            <div className="rounded-2xl flex flex-col justify-between h-full py-16 px-4 lg:p-14" style={cardStyle}>
              <div>
                <h4 className="text-xl font-bold text-white">Sales Reps</h4>
                <p className="mt-4 text-5xl font-bold tracking-tight text-white">
                  $297
          ...
          <AnimatedWrapper delay={150} className="lg:-mt-8">
            <div className="relative rounded-2xl flex flex-col justify-between h-full py-16 px-4 lg:p-14" style={featuredCardStyle}>
